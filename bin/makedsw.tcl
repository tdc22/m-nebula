...
proc gen_package_dsp {name} {
    ...
    puts $cid "!MESSAGE Dies ist kein g�ltiges Makefile. Zum Erstellen dieses Projekts mit NMAKE"
    puts $cid "!MESSAGE verwenden Sie den Befehl \"Makefile exportieren\" und f�hren Sie den Befehl"
    puts $cid "!MESSAGE"
    puts $cid "!MESSAGE NMAKE /f \"$name.mak\"."
    puts $cid "!MESSAGE "
    puts $cid "!MESSAGE Sie k�nnen beim Ausf�hren von NMAKE eine Konfiguration angeben"
    ...
    puts $cid "!MESSAGE "
    puts $cid "!MESSAGE F�r die Konfiguration stehen zur Auswahl:"
    puts $cid "!MESSAGE "
...
proc gen_workspace {name list_of_targets} {
    ...
    puts $cid "# WARNUNG: DIESE ARBEITSBEREICHSDATEI DARF NICHT BEARBEITET ODER GEL�SCHT WERDEN!"
    puts $cid ""
